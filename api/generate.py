...
import json, base64, urllib.request, io, random, os, time
import numpy as np
...
def aplicar_template(photo, copy_text, cta_text):
    ...
    - Foto 1080x1080 arriba
    - Línea dorada divisora
    - Franja blanca 267px con copy + CTA + logo
    """
...
def subir_a_cloudinary(img):
    """Sube la imagen final a Cloudinary y devuelve la URL pública."""
    buf = io.BytesIO()
